  ...
  return (
    <div className='relative'>
      <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4'>
        <div className='bg-gray-100 rounded-xl flex items-start justify-between p-3 cursor-pointer' onClick={() => setShowCalendar(!showCalendar)}>
        ...
        <div className='bg-gray-100 rounded-xl flex flex-col items-start gap-2 p-3'>
